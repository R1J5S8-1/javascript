...
lowerLimitNaturanal = parseInt(prompt("Enter the lower limit for natural numbers: "));
higherLimitNatural = parseInt(prompt("Enter the higher limit for natural numbers: "));

let numbers = [];
console.log("Natural numbers between " + lowerLimitNaturanal + " and " + higherLimitNatural + " are: ");
...
console.log("Odd numbers between " + lowerLimitOdd + " and " + higherLimitOdd + " are: ");
...
console.log("Even numbers between " + lowerLimitEven + " and " + higherLimitEven + " are: ");
...
higherLimitPrime = parseInt(prompt("Enter the higher limit for prime numbers: "));

let primeNumbers = [];

console.log("Prime numbers between " + lowerLimitPrime + " and " + higherLimitPrime + " are: ");
